    ...
    <div class="box-header">                      
      <div class="">         
        ...
        <div class="col-lg-1 pull-right">              
          <a href="{{ url('ngo/create/') }}" class="btn btn-block btn-primary" style="text-decoration:none"><i class="fa fa-plus"></i></a>
          <a href="{{ url('ngo/exportcsv') }}" class="btn btn-block btn-primary" style="text-decoration:none"><i class="fa fa-file-excel-o"></i></a>          
        </div>
      </div>
    </div>
    <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
          <thead>
            <tr role="row">
              ...
              <th class="sorting col-lg-2" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Mobile</th> 
           ...
           @foreach ($ngoslist as $ngos)           
            <tr role="row" class="odd">
              ...
              <td>
                ...
                <a href="{{ url('/ngo/edit/'.$ngos->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                {{Form::open(array('url' => 'ngo/delete/' . $ngos->id ,'method' => 'DELETE','style' => 'display:inline'))}}
                  {{Form::button('<i class="fa fa-trash"></i>', array(
                    'class' => 'btn btn-danger',
                    'data-toggle' => 'modal',
                    'data-target' => '#confirmDelete',
                    'data-title' => trans('Ngo.delete'),
                    'data-message' => 'Are you sure you want to delete this ' . $ngos->name . ' ?',                                        
                    ))
                  }}
                {{Form::close()}} 
              </td>
