...
@section('main-content') 
  <div class="box">
   ...
   <tr>
              ...
              <td>{{$volunteer->occupation_details}}</td>              
              </tr>


                 <tr>
              <td>Area of Interset</td>
              <td>{{$volunteer->areaofinterset}}</td>              
              </tr>


                 <tr>
              <td>Others</td>
              <td>{{$volunteer->others}}</td>              
              </tr>
        ...
        <a href="{{ url('/volunteer/edit/'.$volunteer->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
        {{-- <td>
