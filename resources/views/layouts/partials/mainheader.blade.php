                            ...
                            <li class="user-footer">
                                <div class="pull-left">
									@if (Auth::user()->role_id=='2')
										<a href="{{ url('ngolist')}}" class="btn btn-default btn-flat">{{ trans('message.profile') }}</a>
									@endif
									@if (Auth::user()->role_id=='3')
										<a href="{{ url('volunteerlist') }}" class="btn btn-default btn-flat">{{ trans('message.profile') }}</a>
									@endif
									@if (Auth::user()->role_id=='4')
										<a href="{{ url('donorlist') }}" class="btn btn-default btn-flat">{{ trans('message.profile') }}</a>
									@endif
                                </div>
