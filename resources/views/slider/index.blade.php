  ...
  <div class="box">
    <div class="box-header">                      
      <div class="">         
        ...
        <div class="col-lg-3">      
         {!! Form::open(array('method' => 'get')) !!} 
          <div class="input-group input-group-sm  pull-right" style="width: 150px;">              
            <input type="text" name="table_search" value="{{ $table_search }}" class="form-control pull-right" placeholder="name">
        ...
        <div class="col-lg-1 pull-right">              
          <a href="{{ url('/sliders/create/') }}" class="btn btn-block btn-primary" style="text-decoration:none"><i class="fa fa-plus"></i></a>          
        </div>
      </div>
    </div>
    <div class="box-body">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
          <thead>
            <tr role="row">
              ...
              <th class="sorting col-lg-5" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Position</th> 
              <th class="sorting col-lg-5" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Slider Image</th> 
              <th class="sorting col-lg-5" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Action</th> 
    ...
    height: 110px;" class="img-square m-t-xs img-responsive"  src="{{asset('public/images/defaultAvatar.png')}}">
              ...
              <td>
                ...
                <a href="{{ url('/sliders/'.$slider->id.'/edit/') }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>

                {{Form::open(array('url' => 'slider/delete/' . $slider->id ,'method' => 'DELETE','style' => 'display:inline'))}}
                {{Form::button('<i class="fa fa-trash"></i>', array(
                    'class' => 'btn btn-danger',
                    'data-toggle' => 'modal',
                    'data-target' => '#confirmDelete',
                    'data-title' => trans('message.slider_delete'),
                    'data-message' => 'Are you sure you want to delete this ' . $slider->name . ' ?',                                        
                    ))
                  }}
                {{Form::close()}}
              </td>
