...
<div class="box box-primary col-lg-6">
  <div class="box-header with-border ">
    <h3 class="box-title">{{ trans('message.donor_add') }}</h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  {!! Form::open(array('url' => '/donor/create'),['method' => 'post', 'class' => 'form-horizontal']) !!}
    ...
    <div class="box-body">
      ...
      <div class="form-group {{ $errors->has('panno') ? 'has-error' :'' }}">      
        <div class="input-group col-lg-12">            
          ...
          <input type="text" class="form-control" name="panno" value="{{ old('panno') }}" placeholder="Pan no" >
        </div>        
      </div>
