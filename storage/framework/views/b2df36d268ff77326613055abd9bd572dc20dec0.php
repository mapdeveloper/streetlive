            ...
            <div class="register-box-body">
                ...
                <form action="<?php echo e(url('/register')); ?>" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" placeholder="<?php echo e(trans('message.fullname')); ?>" name="name" value="<?php echo e(old('name')); ?>"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group">
                                <button type="button" class="btn btn-block btn-flat" data-toggle="modal" data-target="#termsModal"><?php echo e(trans('message.terms')); ?></button>
                            </div>
                        </div><!-- /.col -->
                ...
                <a href="<?php echo e(url('/login')); ?>" class="text-center"><?php echo e(trans('message.membreship')); ?></a>
            </div><!-- /.form-box -->
        </div><!-- /.register-box -->
    </div>
