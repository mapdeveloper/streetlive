...
<header class="main-header">
    ...
    <a href="<?php echo e(url('/home')); ?>" class="logo">
        ...
        <span class="logo-mini" title="Mapol"><b>M</b>AP</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>MAPOL</b></span>
    </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small><?php echo e(trans('message.login')); ?> Nov. 2012</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                                <div class="col-xs-4 text-center">
                                    <a href="#"><?php echo e(trans('message.followers')); ?></a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="#"><?php echo e(trans('message.sales')); ?></a>
                                </div>
                                <div class="col-xs-4 text-center">
                                    <a href="#"><?php echo e(trans('message.friends')); ?></a>
                                </div>
                            </li>
                            <!-- Menu Footer-->
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?php echo e(url('/settings')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('message.profile')); ?></a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-flat"
                                       onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();">
                                        <?php echo e(trans('message.signout')); ?>
